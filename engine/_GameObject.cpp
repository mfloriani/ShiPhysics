...
//
//_GameObject::_GameObject(std::string tag, glm::vec2 position, float mass, SDL_Texture* sprite) : 
//	m_position(position), 
...
//	m_tag(tag), 
//	m_active(true),
//	m_currentState(_GameObject::States::alive)
//{
//	UpdateDirection();
//	SetCollider();
//}
//
//_GameObject::_GameObject(std::string tag, glm::vec2 position, float mass, SDL_Texture* sprite, glm::vec2 direction) :
//	m_position(position), 
//	m_mass(mass), 
//	m_sprite(sprite), 
//	m_angleRadian(0.0f), 
...
//}
//
//glm::vec2 _GameObject::CalculateForces()
//{
//	return glm::vec2();
//}
//
//void _GameObject::Update(float secs)
//{
//	if (!m_active) return;
//
...
//}
//
//SDL_Rect _GameObject::GetCollider()
//{
//	return m_collider;
//}
//
//glm::vec2 _GameObject::GetPosition()
//{
//	return m_position;
//}
//
//glm::vec2 _GameObject::GetDirection()
//{
//	return m_direction;
//}
//
//glm::vec2 _GameObject::GetMomentum()
//{
//	return m_momentum;
//}
//
//std::string _GameObject::GetTag()
//{
//	return m_tag;
//}
//
//bool _GameObject::IsActive()
//{
//	return m_active;
//}
//
//int _GameObject::GetCurrentState()
//{
